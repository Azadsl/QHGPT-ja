    ...
    <div my-6>
      ...
      >
        <div class="my-4 flex items-center gap-2 transition-opacity">
          ...
          />
          <button onClick={handleButtonClick} class="h-12 px-3 py-2 bg-slate-600 text-white rounded-lg shadow hover:bg-slate-700 transition-all duration-200">
            卍
          </button>
          <button title="清除对话" onClick={clear} class="h-12 px-3 py-2 bg-slate-600 text-white rounded-lg shadow hover:bg-slate-700 transition-all duration-200">
            <IconClear />
          </button>
          <button title="导出Markdown" onClick={exportToMarkdown} class="h-12 px-3 py-2 bg-slate bg-op-15 hover:bg-op-20 rounded-sm">
